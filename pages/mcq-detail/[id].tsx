...
const mcqLocations: Record<string, { unit: string; sections: string[] }> = {
  ...
  "4": { unit: "unit7", sections: ["7-1", "7-2"] },
  "5": { unit: "unit6", sections: ["6-3", "6-4"] },
  "6": { unit: "unit1", sections: ["1-7", "1-8"] },
  "7": { unit: "unit4", sections: ["4-4", "4-5"] },
  "8": { unit: "unit4", sections: ["4-7", "4-8"] },
  "9": { unit: "unit1", sections: ["1-7", "1-8"] },
  "10": { unit: "unit3", sections: ["3-1", "3-2", "3-3"] },
  "11": { unit: "unit7", sections: ["7-1", "7-2"] },
  "12": { unit: "unit3", sections: ["3-1", "3-2", "3-3"] },
  "13": { unit: "unit1", sections: ["1-7", "1-8"] },
  "14": { unit: "unit1", sections: ["1-10"] },
  "15": { unit: "unit1", sections: ["1-6"] },
  "16": { unit: "unit2", sections: ["2-2"] },
  "17": { unit: "unit7", sections: ["7-3", "7-4"] },
  "18": { unit: "unit2", sections: ["2-4"] },
  "19": { unit: "unit1", sections: ["1-10"] },
  "20": { unit: "unit6", sections: ["6-7", "6-8"] },
  "21": { unit: "unit5", sections: ["5-3", "5-4", "5-7", "5-8"] },
  "22": { unit: "unit6", sections: ["6-5", "6-6"] },
  "23": { unit: "unit6", sections: ["6-1", "6-2"] },
  "24": { unit: "unit3", sections: ["3-6", "3-7"] },
  "25": { unit: "unit4", sections: ["4-7", "4-8"] },
  "26": { unit: "unit8", sections: ["8-3", "8-4"] },
  "27": { unit: "unit9", sections: ["9-5", "9-6"] },
  "28": { unit: "unit6", sections: ["6-1", "6-2"] },
  "29": { unit: "unit1", sections: ["1-6", "1-7", "1-8", "1-9"] },
  "30": { unit: "unit5", sections: ["5-7", "5-8"] },
  "31": { unit: "unit2", sections: ["2-5"] },
  "32": { unit: "unit4", sections: ["4-12"] },
  "33": { unit: "unit9", sections: ["9-1", "9-2"] },
  "34": { unit: "unit4", sections: ["4-9", "4-10"] },
  "35": { unit: "unit3", sections: ["3-1", "3-2", "3-3"] },
  "36": { unit: "unit6", sections: ["6-7", "6-8"] },
  "37": { unit: "unit3", sections: ["3-1", "3-2", "3-3"] },
  "38": { unit: "unit7", sections: ["7-5", "7-6"] },
  "39": { unit: "unit6", sections: ["6-1", "6-2"] },
  "40": { unit: "unit6", sections: ["6-5", "6-6", "6-11"] },
};
